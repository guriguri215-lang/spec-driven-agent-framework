"""Runtime authority for the JSON Schema subset published by this repository."""
...
class LocalSchemaValidator:
    ...
    def _validate_string(
        ...
        if schema.get("format") == "date-time":
            ...
            parsed_text = instance
            if instance[17:19] == "60":
                parsed_text = f"{instance[:17]}59{instance[19:]}"
            try:
                datetime.fromisoformat(parsed_text.replace("Z", "+00:00"))
